  ...
  return (
    <div className="relative w-full h-full select-none overflow-hidden bg-[#fafbfe] sm:rounded-[44px] flex flex-col justify-between">
      ...
      <div className="w-full px-5 sm:px-6 flex flex-col items-center text-center z-20 flex-1 justify-center py-1">
        ...
        <div className="w-15 h-15 sm:w-16 sm:h-16 rounded-full bg-[#eeeefa] flex items-center justify-center shadow-[0_4px_16px_rgba(84,78,229,0.12)] mb-2">
          <img
        ...
        {/* Subtitle */}
        <p className="text-[13px] sm:text-[13.5px] leading-snug text-[#737ea1] max-w-[270px] mb-3.5">
          ...
          {REGIONS.map((region) => {
            ...
            return (
              <button
                ...
                className={`w-full h-[54px] sm:h-[58px] px-2.5 sm:px-3 rounded-2xl flex items-center justify-between transition-all duration-150 cursor-pointer ${
                  isSelected
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <img
                    ...
                    alt={region.name}
                    className="w-14 h-9 sm:w-[62px] sm:h-[40px] object-cover rounded-xl shadow-xs shrink-0 pointer-events-none"
                  />
                  <span className="text-[14.5px] sm:text-[15px] font-bold text-[#111936] tracking-tight">
                    {region.name}
                  </span>
                </div>
