...
export default function ExplorePage({ onBack, onNavigate }) {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-[#fafbfe] sm:rounded-[44px] flex flex-col justify-between select-none">
      {/* Scrollable Main Content with generous bottom padding so all elements are 100% visible */}
      <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain touch-pan-y pb-36 sm:pb-40 scrollbar-none">
        {/* Top iOS Status Bar (9:41) */}
        ...
        <div className="px-5 pt-3 pb-2 flex items-center justify-between">
          <div className="flex items-center gap-0.5 cursor-pointer">
            <h1 className="text-[25px] sm:text-[27px] font-black tracking-tight text-[#0c1228] font-sans flex items-center">
              <span>PLAN</span>
        ...
        {/* Hero Section with World Map & 3 Pinned Polaroids (matching c29.png) */}
        <div className="relative px-5 pt-2 pb-4">
          ...
          <div className="grid grid-cols-12 items-center gap-2">
            ...
            <div className="col-span-7 sm:col-span-7 pr-1">
              <p className="text-[9.5px] sm:text-[10px] font-extrabold uppercase tracking-wider text-[#717ea1] leading-tight">
                A PERSONALISED GUIDE, <br />
                BUILT INSIDE YOUR MAP
              </p>
              <h2 className="text-[25px] sm:text-[28px] font-black text-[#0f1738] tracking-tight leading-[1.08] mt-2 font-serif">
                Discover, buy <br />
                and create <br />
            ...
            {/* Right Hero Polaroid Cluster (New York, Bali, Tokyo with Purple Pins) */}
            <div className="col-span-5 sm:col-span-5 relative flex justify-end">
              <div
                onClick={() => onNavigate && onNavigate('map-detail')}
                className="relative w-full max-w-[180px] aspect-[1/1] cursor-pointer hover:scale-105 transition-transform duration-300"
              >
                <img
                  src="/c29-polaroids.png"
                  alt="New York, Bali, Tokyo Travel Maps"
                  className="w-full h-full object-contain pointer-events-none filter drop-shadow-[0_8px_20px_rgba(84,78,229,0.18)]"
                />
              </div>
            </div>
          </div>
        ...
        <div className="px-5 pt-1 space-y-3">
          ...
          >
            {filteredMaps.map((map) => (
              <div
                key={map.id}
                className="w-[230px] sm:w-[245px] bg-white rounded-[26px] border border-[#e4e8f7] overflow-hidden shadow-[0_4px_16px_rgba(50,70,140,0.06)] hover:border-slate-300 transition-all shrink-0 snap-start flex flex-col justify-between group"
              >
                ...
                <div className="p-3.5 space-y-2 flex-1 flex flex-col justify-between">
                  ...
                  >
                    ...
                    />
                    <span className="text-[12px] font-bold text-[#0f1738] truncate">
                      {map.creatorHandle}
                    </span>
                  </div>
