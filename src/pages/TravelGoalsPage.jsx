          ...
          {GOALS.map((goal) => {
            ...
            return (
              <button
                ...
                className={`w-full h-[62px] sm:h-[66px] px-3 sm:px-3.5 rounded-2xl flex items-center justify-between transition-all duration-150 cursor-pointer ${
                  isSelected
              ...
              >
                ...
                <div className="flex items-center gap-3 text-left">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[14px] sm:text-[14.5px] font-bold text-[#111936] tracking-tight leading-tight">
                      {goal.title}
                    </span>
                    <span className="text-[12px] sm:text-[12.5px] text-[#717ea1] leading-tight mt-0.5">
                      {goal.subtitle}
                    </span>
                  </div>
                </div>
